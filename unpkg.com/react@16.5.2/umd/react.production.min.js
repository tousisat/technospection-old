...
'use strict';
(function(D, k) {
    "object" === typeof exports && "undefined" !== typeof module ? module.exports = k() : "function" === typeof define && define.amd ? define(k) : D.React = k()
})(this, function() {
        ...
        try {
            if (a)
                for (; null !== e;) {
                    var b = m();
                    if (e.timesOutAt <= b) {
                        do V(); while (null !== e && e.timesOutAt <= b)
                    } else break
                } else if (null !== e) {
                    do V(); while (null !== e && 0 < q() - m())
                }
        } finally {
            G = !1, null !== e ? F(e) : H = !1
        }
    ...
    function X(a, b, c) {
        var d = void 0,
            ...
            f = null;
        if (null != b)
            for (d in void 0 !== b.ref &&
                (f = b.ref), void 0 !== b.key && (e = "" + b.key), b) Y.call(b, d) && !Z.hasOwnProperty(d) && (g[d] = b[d]);
    ...
    function L(a, b, c, d) {
        ...
        if (Array.isArray(a))
            for (var f = 0; f < a.length; f++) {
                ...
                var h = b + M(g, f);
                e += L(g, h, c, d)
            } else if (null === a || "object" !== typeof a ? h = null : (h = ca && a[ca] || a["@@iterator"], h = "function" === typeof h ? h : null), "function" === typeof h)
                for (a = h.call(a), f = 0; !(g = a.next()).done;) g = g.value, h = b + M(g, f++), e += L(g, h, c, d);
    ...
    function M(a, b) {
        return "object" === typeof a && null !== a && null != a.key ? ra(a.key) : b.toString(36)
    }
    ...
    function ua(a, b, c) {
        ...
        Array.isArray(a) ? O(a, d, c, function(a) {
            return a
        }) : null != a && (K(a) && (a = qa(a, e + (!a.key || b && b.key === a.key ? "" : ("" + a.key).replace(da, "$&/") + "/") + c)), d.push(a))
    }
    ...
    var ca = "function" === typeof Symbol && Symbol.iterator,
        ...
        y = function() {
            ...
            for (var d, e = 1; e < arguments.length; e++) {
                ...
                if (ea) {
                    d = ea(f);
                    for (var h = 0; h < d.length; h++) Ca.call(f, d[h]) && (c[d[h]] = f[d[h]])
                }
            }
            return c
        },
    ...
    p.prototype.setState = function(a, b) {
        "object" !== typeof a && "function" !== typeof a && null != a ? k("85") : void 0;
    ...
    var W = {
        ...
        fa = "function" === typeof requestAnimationFrame ? requestAnimationFrame : void 0,
        ha = "function" === typeof cancelAnimationFrame ? cancelAnimationFrame :
        void 0,
        ia, ja, ka = function(a) {
            ia = fa(function(b) {
                Fa(ja);
    ...
    } else if (window._schedMock) f = window._schedMock, J = f[0], I = f[1], q = f[2];
    else {
        "undefined" !== typeof console && ("function" !== typeof fa && console.error("This browser doesn't support requestAnimationFrame. Make sure that you load a polyfill in older browsers. https://fb.me/react-polyfills"),
            "function" !== typeof ha && console.error("This browser doesn't support cancelAnimationFrame. Make sure that you load a polyfill in older browsers. https://fb.me/react-polyfills"));
        var z = null,
            A = !1,
            t = -1,
            u = !1,
    ...
    y(f, {
        Schedule: {
            ...
            unstable_scheduleWork: function(a, b) {
                var c = m();
                b = void 0 !== b && null !== b && null !== b.timeout && void 0 !== b.timeout ? c + b.timeout : c + 5E3;
                a = {
                    callback: a,
                    timesOutAt: b,
                    next: null,
    ...
    l = {
        ...
        cloneElement: function(a, b, c) {
            ...
            if (null != b) {
                ...
                for (d in b) Y.call(b, d) && !Z.hasOwnProperty(d) && (e[d] = void 0 === b[d] && void 0 !== l ? l[d] : b[d])
            }
